...
- This authorization does not bypass CI, branch protection, risk classification, the independent agent-review gate for non-routine changes, or qualified servant-leader escalation boundaries. Historical activity is evidence only and never creates an operating prerequisite.
