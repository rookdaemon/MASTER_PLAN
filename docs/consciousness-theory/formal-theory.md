...
### 7.8 Complete NCC-to-ISMT Mapping Table

The following table provides an explicit mapping from every entry in the 0.1.1.1 NCC catalogue to ISMT terms. Each NCC entry is classified as either constitutive of an ISMT component (IC, SM, or GA) or as an enabling condition (prerequisite) for one or more components.

| NCC Catalogue Entry | Catalogue Distinction | ISMT Role | ISMT Component(s) | Mapping Rationale |
|---|---|---|---|---|
| **Reticular Activating System (RAS)** | Prerequisite | Enabling condition | IC, SM, GA (all) | Brainstem arousal is a global prerequisite — without arousal, cortical integration collapses, self-model cannot be maintained, and no global broadcast occurs. RAS enables the thalamocortical dynamics on which all three conditions depend. |
| **Thalamocortical Connectivity** | Prerequisite | Enabling condition + partial constitutive | IC (enabling), GA (constitutive) | Thalamocortical loops provide the infrastructure for cortical integration (enabling IC) and serve as the primary broadcast relay (constitutive of GA). Disruption under anesthesia degrades both IC and GA simultaneously. See §7.1. |
| **Intralaminar Thalamic Nuclei** | Prerequisite | Enabling condition | IC, GA | Intralaminar nuclei support widespread cortical activation; their bilateral lesions produce vegetative state by eliminating the enabling conditions for cortical integration and global broadcast. They gate access to the conscious state without determining its content. |
| **Posterior Cortical Hot Zone (Visual)** | NCC-proper | Constitutive | SM (content) | The posterior visual cortex implements the sensory content of the self-model — the "what" of visual conscious experience. V1-V4-IT hierarchy provides the representational substrate for visual SM. See §7.2. |
| **Recurrent Processing in Visual Cortex** | NCC-proper | Constitutive | IC + SM (mechanism) | Recurrent feedback loops are the neural implementation of two ISMT requirements: (1) they create integration across cortical layers (IC — information flows bidirectionally, preventing decomposition), and (2) they implement the prediction-comparison cycle of SM (predictions flow top-down, errors flow bottom-up). Per Proposition 2, feed-forward-only processing cannot satisfy SM. |
| **V5/MT and Motion Awareness** | NCC-proper | Constitutive | SM (content) | V5/MT implements motion-specific content within the visual self-model. Lesions produce akinetopsia — loss of specific SM content (motion qualia) while other visual SM content is preserved. Maps to the representational criterion of SM for motion modality. |
| **Primary/Secondary Auditory Cortex** | NCC-proper | Constitutive | SM (content) | Implements auditory content within the self-model. Bilateral lesions produce cortical deafness — loss of auditory SM content. Thalamocortical recurrence in auditory pathways provides IC for auditory binding. |
| **Temporal Binding in Auditory Cortex** | NCC-proper (debated) | Constitutive | IC (mechanism) | Gamma-band synchronization implements temporal integration of auditory information — the binding of discrete auditory events into unified percepts. This is a modality-specific mechanism supporting IC within auditory processing. |
| **Primary/Secondary Somatosensory Cortex** | NCC-proper | Constitutive | SM (content) | S1/S2 implement tactile/proprioceptive content within the self-model. The somatotopic map in S1 provides structured self-representation of body surface — a core component of the bodily self-model. |
| **Insular Cortex (Interoceptive Awareness)** | NCC-proper | Constitutive | SM (content) | The insula implements interoceptive self-modeling — the system's representation of its own internal bodily states. The posterior-to-anterior gradient (posterior: raw interoception → anterior: subjective feeling) maps to increasing SM quality Q(M) for visceral content. See §7.7. |
| **Amygdala** | Prerequisite (debated) | Enabling condition | SM (emotional content) | The amygdala processes threat-related information both consciously and unconsciously, indicating it is upstream of consciousness — an enabling condition for emotional SM content rather than constitutive. It provides the valence signal that the self-model incorporates when emotional content becomes conscious via GA. |
| **Anterior Insula / ACC** | NCC-proper | Constitutive | SM (content) + GA (interface) | AIC/ACC implement the subjective "feeling" dimension of the self-model and serve as an interface between interoceptive SM and global broadcast (GA). ACC's role in salience detection gates which self-model contents achieve global accessibility. |
| **Prefrontal Cortex (PFC)** | Consequence (debated) | Constitutive of access, not phenomenality | GA (access mechanism) | PFC implements cognitive access and reportability — a key component of GA (global broadcast to executive systems). However, PFC is not required for phenomenal consciousness (preserved after lobotomy, deactivated during REM dreaming). ISMT predicts PFC contributes to GA but is not the sole GA mechanism. See §7.3. |
| **Temporoparietal Junction (TPJ)** | NCC-proper | Constitutive | SM (self-referential) | TPJ implements the self-other distinction and bodily ownership components of SM. Lesions produce anosognosia and out-of-body experiences — disruptions of the self-model's spatial and agentive content. TPJ satisfies SM's self-referential criterion for bodily self-consciousness. |
| **Posterior Cortical Hot Zone (Cross-Modal)** | NCC-proper | Constitutive | SM (content) + IC (integration) | The temporo-parieto-occipital zone is the primary locus of conscious content — it implements multi-modal SM content and provides the integration structure (IC) for binding content across modalities. Its identification as the minimal sufficient NCC aligns with ISMT: it is where SM and IC converge. See §7.2. |
| **Claustrum** | Uncertain | Enabling/constitutive (speculative) | IC (hub) + GA (coordination) | The claustrum's dense reciprocal cortical connections suggest a role as an integration hub (IC) and cross-modal coordination mechanism (GA). Consistent with but not required by ISMT — claustrum may enhance IC and GA without being strictly necessary. See §7.5. |
| **Default Mode Network (DMN)** | NCC-proper (self-content) | Constitutive | SM (self-referential) | DMN implements narrative self-model content — identity, temporal continuity, and autobiographical self-representation. This is the self-referential component of SM (I(m(t); dm/dt)). DMN suppression during meditation/psychedelics reduces self-referential SM without eliminating consciousness — consistent with ISMT's prediction that SM has separable sub-components. See §7.4. |
| **Global Workspace / Frontoparietal Network** | Consequence (debated) | Constitutive | GA (primary mechanism) | The frontoparietal network implements global broadcasting — the primary neural substrate of GA. Its "ignition" dynamics correspond to the threshold transition from local to global accessibility. ISMT predicts this network is constitutive of GA (access consciousness) but not of phenomenal consciousness per se, consistent with no-report paradigm findings. |
