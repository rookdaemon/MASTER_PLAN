...
The human serves as servant leader by setting goals, constraints, and constitutional values. The
automated process and its agents form the operating body: they analyze, plan, test, review, retry,
publish, merge, and run bounded actions within those constraints.
...
and record at least two automated alternatives, attach evidence, explain why it cannot perform the
